  ...
  return (
    <div className="flex min-h-[520px] items-center justify-center">
      <div className="max-w-md text-center">
        ...
        <p className="text-sm font-semibold uppercase text-brand-blue">Admin Panel</p>
        <h1 className="mt-2 text-2xl font-bold text-brand-black">Página de admin no encontrada</h1>
