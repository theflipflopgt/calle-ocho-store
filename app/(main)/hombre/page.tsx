...
export const metadata = {
  title: 'Tenis para Hombre | Calle Ocho Store',
  description: 'Descubre nuestra colección de tenis para hombre. Las mejores marcas: Nike, Adidas, Jordan, New Balance y más.',
};
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-6 lg:gap-8">
      ...
      <div className="flex-1">
        ...
        <ProductGrid
          products={products}
          emptyMessage="No encontramos productos para hombre con estos filtros"
        />
      </div>
    </div>
  );
...
export default async function HombrePage({ searchParams }: PageProps) {
  return (
